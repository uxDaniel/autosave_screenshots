...
class ScreenshotsMover:
    def __init__(
        ...
        preview_dimensions=[(728, 360), (455, 225), (364, 180)], # previews generated by Snipping Tool, to be ignored
        delay_seconds=2,
        do_cleanup=True,
    ):
    ...
    def move_screenshots(self, old_filenames, new_filenames):
        for i in range(len(old_filenames)):
            ...
            logging.info(f"{source}\\{old_filenames[i]}  ➔   {target}\\{new_filenames[i]}")
